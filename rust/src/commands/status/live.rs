...
fn build_live_instance_discovery_with_request<F>(request_json: &mut F) -> Value
where
...
fn build_live_status_discovery(client: &JsonHttpClient) -> Value {
...
mod tests {
    use super::{
        build_live_instance_discovery_with_request, build_live_multi_org_domain_status_with_orgs,
