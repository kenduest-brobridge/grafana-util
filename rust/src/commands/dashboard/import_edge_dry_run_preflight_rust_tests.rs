...
#[test]
fn import_dashboards_with_dry_run_surfaces_target_review_evidence() {
        ...
        |_method, path, _params, _payload| match path {
            ...
            "/api/dashboards/uid/abc" => Ok(Some(json!({
                ...
                "meta": {
                    ...
                    "repository": "grafana-dashboard-repo"
                }
            }))),
    ...
    .unwrap();
    assert_eq!(value["summary"]["targetWarningCount"], json!(1));
    assert_eq!(value["summary"]["targetBlockedCount"], json!(0));
}
