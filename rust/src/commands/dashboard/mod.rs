...
pub const CLASSIC_EXPORT_SUBDIR: &str = "classic";
pub const RESOURCE_V1_EXPORT_SUBDIR: &str = "resource-v1";
pub const RESOURCE_V2_EXPORT_SUBDIR: &str = "resource-v2";
pub const RESOURCE_OBJECTS_SUBDIR: &str = "objects";
