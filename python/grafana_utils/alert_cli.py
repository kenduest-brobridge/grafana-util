...
__all__ = [
    ...
    "build_contact_point_export_document",
    "build_contact_point_import_payload",
    "build_contact_point_output_path",
    "build_import_operation",
    "build_json_http_transport",
    "build_mute_timing_export_document",
    "build_mute_timing_import_payload",
    "build_mute_timing_output_path",
    "build_parser",
    "build_policies_export_document",
    "build_resource_dirs",
    "build_rule_export_document",
    "build_rule_import_payload",
    "build_rule_output_path",
    "build_template_export_document",
    "build_template_import_payload",
    "diff_alerting_resources",
    "discover_alert_resource_files",
    "export_alerting_resources",
    "import_alerting_resources",
    "list_alert_resources",
    "load_json_file",
    "load_panel_id_map",
    "load_string_map",
    "main",
...
def _build_alert_list_plan(
    ...
    if (all_orgs or org_id) and not headers.get("Authorization", "").startswith(
        "Basic "
    ):
        raise GrafanaError(
...
def list_alert_resources(args: argparse.Namespace) -> int:
    ...
    serializer: Callable[[list[dict[str, Any]]], list[dict[str, Any]]]
    ...
    for org, client in _build_alert_list_plan(args):
        ...
        if (
            bool(getattr(args, "all_orgs", False))
            or str(getattr(args, "org_id", "") or "").strip()
        ):
