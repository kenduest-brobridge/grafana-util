...
def build_parser(prog=None):
    ...
    user_export_parser = user_subparsers.add_parser(
        ...
        **subparser_kwargs(USER_EXPORT_HELP_EXAMPLES),
    )
    add_common_cli_args(
        user_export_parser,
        allow_token_auth=True,
    ...
    user_import_parser = user_subparsers.add_parser(
        ...
        **subparser_kwargs(USER_IMPORT_HELP_EXAMPLES),
    )
    add_common_cli_args(
        user_import_parser,
        allow_token_auth=True,
    ...
    user_diff_parser = user_subparsers.add_parser(
        ...
        **subparser_kwargs(USER_DIFF_HELP_EXAMPLES),
    )
    add_common_cli_args(
        user_diff_parser,
        allow_token_auth=True,
    ...
    add_parser = user_subparsers.add_parser(
        ...
        **subparser_kwargs(USER_ADD_HELP_EXAMPLES),
    )
    add_common_cli_args(
        add_parser,
    ...
    modify_parser = user_subparsers.add_parser(
        ...
        **subparser_kwargs(USER_MODIFY_HELP_EXAMPLES),
    )
    add_common_cli_args(
        modify_parser,
        allow_token_auth=False,
    ...
    delete_parser = user_subparsers.add_parser(
        ...
        **subparser_kwargs(USER_DELETE_HELP_EXAMPLES),
    )
    add_common_cli_args(
        delete_parser,
        username_dest="auth_username",
    ...
    team_parser = subparsers.add_parser(
        "team", help="List Grafana teams.", **subparser_kwargs()
    )
    ...
    team_add_parser = team_subparsers.add_parser(
        ...
        **subparser_kwargs(TEAM_ADD_HELP_EXAMPLES),
    )
    ...
    team_modify_parser = team_subparsers.add_parser(
        ...
        **subparser_kwargs(TEAM_MODIFY_HELP_EXAMPLES),
    )
    ...
    team_export_parser = team_subparsers.add_parser(
        ...
        **subparser_kwargs(TEAM_EXPORT_HELP_EXAMPLES),
    )
    ...
    team_import_parser = team_subparsers.add_parser(
        ...
        **subparser_kwargs(TEAM_IMPORT_HELP_EXAMPLES),
    )
    add_common_cli_args(
        team_import_parser,
        username_dest="auth_username",
    ...
    team_diff_parser = team_subparsers.add_parser(
        ...
        **subparser_kwargs(TEAM_DIFF_HELP_EXAMPLES),
    )
    add_common_cli_args(
        team_diff_parser,
        username_dest="auth_username",
    ...
    org_list_parser = org_subparsers.add_parser(
        ...
        **subparser_kwargs(ORG_LIST_HELP_EXAMPLES),
    )
    add_common_cli_args(
        org_list_parser,
        allow_token_auth=False,
    ...
    org_add_parser = org_subparsers.add_parser(
        ...
        **subparser_kwargs(ORG_ADD_HELP_EXAMPLES),
    )
    add_common_cli_args(
        org_add_parser,
        allow_token_auth=False,
    ...
    org_modify_parser = org_subparsers.add_parser(
        ...
        **subparser_kwargs(ORG_MODIFY_HELP_EXAMPLES),
    )
    add_common_cli_args(
        org_modify_parser,
        allow_token_auth=False,
    ...
    org_delete_parser = org_subparsers.add_parser(
        ...
        **subparser_kwargs(ORG_DELETE_HELP_EXAMPLES),
    )
    add_common_cli_args(
        org_delete_parser,
        allow_token_auth=False,
    ...
    org_export_parser = org_subparsers.add_parser(
        ...
        **subparser_kwargs(ORG_EXPORT_HELP_EXAMPLES),
    )
    add_common_cli_args(
        org_export_parser,
        allow_token_auth=False,
    ...
    org_import_parser = org_subparsers.add_parser(
        ...
        **subparser_kwargs(ORG_IMPORT_HELP_EXAMPLES),
    )
    add_common_cli_args(
        org_import_parser,
        allow_token_auth=False,
    ...
    service_account_list_parser = service_account_subparsers.add_parser(
        ...
        **subparser_kwargs(SERVICE_ACCOUNT_LIST_HELP_EXAMPLES),
    )
    ...
    service_account_add_parser = service_account_subparsers.add_parser(
        ...
        **subparser_kwargs(SERVICE_ACCOUNT_ADD_HELP_EXAMPLES),
    )
    ...
    service_account_export_parser = service_account_subparsers.add_parser(
        ...
        **subparser_kwargs(SERVICE_ACCOUNT_EXPORT_HELP_EXAMPLES),
    )
    ...
    service_account_import_parser = service_account_subparsers.add_parser(
        ...
        **subparser_kwargs(SERVICE_ACCOUNT_IMPORT_HELP_EXAMPLES),
    )
    ...
    service_account_diff_parser = service_account_subparsers.add_parser(
        ...
        **subparser_kwargs(SERVICE_ACCOUNT_DIFF_HELP_EXAMPLES),
    )
    ...
    service_account_delete_parser = service_account_subparsers.add_parser(
        ...
        **subparser_kwargs(SERVICE_ACCOUNT_DELETE_HELP_EXAMPLES),
    )
    ...
    service_account_token_parser = service_account_subparsers.add_parser(
        ...
        **subparser_kwargs(SERVICE_ACCOUNT_TOKEN_ROOT_HELP_EXAMPLES),
    )
    ...
    service_account_token_add_parser = service_account_token_subparsers.add_parser(
        ...
        **subparser_kwargs(SERVICE_ACCOUNT_TOKEN_ADD_HELP_EXAMPLES),
    )
    ...
    service_account_token_delete_parser = service_account_token_subparsers.add_parser(
        ...
        **subparser_kwargs(SERVICE_ACCOUNT_TOKEN_DELETE_HELP_EXAMPLES),
    )
