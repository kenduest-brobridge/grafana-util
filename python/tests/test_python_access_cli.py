...
MODULE_PATH = PYTHON_ROOT / "grafana_utils" / "access_cli.py"
PARSER_MODULE_PATH = PYTHON_ROOT / "grafana_utils" / "access" / "parser.py"
WORKFLOWS_MODULE_PATH = PYTHON_ROOT / "grafana_utils" / "access" / "workflows.py"
CLIENT_MODULE_PATH = PYTHON_ROOT / "grafana_utils" / "clients" / "access_client.py"
MODELS_MODULE_PATH = PYTHON_ROOT / "grafana_utils" / "access" / "models.py"
...
class AccessCliTests(unittest.TestCase):
    ...
    def test_access_parse_args_service_account_token_without_subcommand_prints_token_help(
        self,
    ):
        stdout = io.StringIO()
        with redirect_stdout(stdout):
    ...
    def test_access_parse_args_supports_user_export_mode_with_overwrite_and_dry_run(
        self,
    ):
        args = access_utils.parse_args(
            [
    ...
    def test_access_parse_args_supports_user_import_mode_with_token_auth(self):
        args = access_utils.parse_args(
            [
                "user",
                "import",
    ...
    def test_access_parse_args_supports_team_export_mode_with_token_auth(self):
        args = access_utils.parse_args(
            [
                "team",
                "export",
    ...
    def test_access_parse_args_supports_team_import_mode_with_confirmation(self):
        args = access_utils.parse_args(
            [
                "team",
                "import",
    ...
    def test_access_service_account_token_delete_help_includes_confirmation_example(
        self,
    ):
        parser = access_utils.build_parser()
        token_delete_parser = (
    ...
    def test_access_modify_team_with_client_rejects_admin_changes_without_metadata(
        self,
    ):
        client = FakeAccessClient(
            org_users=[
    ...
    def test_access_sync_team_members_for_import_updates_admin_and_membership_state(
        self,
    ):
    ...
    def test_access_add_user_with_client_uses_expected_payload_and_follow_up_calls(
        self,
    ):
        client = FakeAccessClient()
        args = argparse.Namespace(
    ...
    def test_access_diff_service_accounts_with_client_returns_expected_difference_count(
        self,
    ):
        client = FakeAccessClient(
            service_accounts=[
    ...
    def test_access_dispatch_access_command_routes_service_account_export_import_diff(
        self,
    ):
        client = FakeAccessClient()
        args = argparse.Namespace(
