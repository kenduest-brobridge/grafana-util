...
如果要對照每個工作流對應的精確旗標，請搭配 [dashboard](../../commands/zh-TW/dashboard.md)、[access](../../commands/zh-TW/access.md)、[alert](../../commands/zh-TW/alert.md)、[change](../../commands/zh-TW/change.md)、[config profile](../../commands/zh-TW/profile.md) 與 [指令詳細說明總索引](../../commands/zh-TW/index.md) 一起看。
